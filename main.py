...
if __name__ == "__main__":
    try:
        ...
        print("✓ Post successfully published on X (Twitter)")
    except FileNotFoundError as e:
        print(f"Error: {e}")
        print("Please ensure the crypto data files exist in the specified DATA_PATH")
